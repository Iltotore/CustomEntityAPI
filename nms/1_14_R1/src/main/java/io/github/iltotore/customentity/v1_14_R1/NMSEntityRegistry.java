package io.github.iltotore.customentity.v1_14_R1;
...
public class NMSEntityRegistry extends HashCustomRegistry {
    ...
    public void applyRegister(CustomEntityRoot<? extends Entity> type) {
        ...
        Map<Object, Type<?>> typeMap = (Map<Object, Type<?>>) DataConverterRegistry.a().getSchema(DataFixUtils.makeKey(DataFixUtils.makeKey(SharedConstants.a().getWorldVersion()))).findChoiceType(DataConverterTypes.ENTITY).types();
        typeMap.put(minecraftKey.toString(), typeMap.get(baseKey));
        try {
            Constructor<? extends net.minecraft.server.v1_14_R1.Entity> constructor = (Constructor<? extends net.minecraft.server.v1_14_R1.Entity>) type.getNMSClass(ServerVersion.v1_14).getConstructor(EntityTypes.class, World.class);


            EntityTypes.b<? extends net.minecraft.server.v1_14_R1.Entity> nmsCreator = (entityType, world) -> {
                net.minecraft.server.v1_14_R1.Entity entity = null;
                try {
            ...
            EntityTypes<net.minecraft.server.v1_14_R1.Entity> customEntityNMSEntityType = EntityTypes.a.a(nmsCreator, nmsCreatureType)
                    .a(type.getKey());

            IRegistry.ENTITY_TYPE.a(type.getBaseID(ServerVersion.v1_14), minecraftKey, customEntityNMSEntityType);

            //Is an insentient entity? Also copy the EntityPositionTypes value.
            if(type.getNMSClass(ServerVersion.v1_14).isAssignableFrom(EntityInsentient.class)) {
            ...
            if(type.isVanilla(ServerVersion.v1_14)) overrideSpawn(nmsCreatureType, baseKey, customEntityNMSEntityType);
    ...
    private void registerSpawn(EnumCreatureType creatureType, EntityTypes<? extends net.minecraft.server.v1_14_R1.Entity> customType, BiomeSpawn spawn) {
    ...
    private void overrideSpawn(EnumCreatureType creatureType, MinecraftKey baseKey, EntityTypes<? extends net.minecraft.server.v1_14_R1.Entity> customType) {
        IRegistry.BIOME.d()
                .map(biomeBase -> biomeBase.getMobs(creatureType))
                .filter(Objects::nonNull)
                .flatMap(List::stream)
                .filter(meta -> Objects.equals(((IRegistry<EntityTypes<? extends net.minecraft.server.v1_14_R1.Entity>>) IRegistry.ENTITY_TYPE).getKey(meta.b), baseKey))
                .forEach((ThrowingConsumer<BiomeBase.BiomeMeta>) biomeMeta -> biomeEntityType.set(biomeMeta.b, customType));
    }
}